...
export function StressAlertDialog({
  ...
  const content = useMemo(() => {
    ...
    const sevEmoji = { high: "🔴", medium: "🟡", low: "🟢" }[severity];

    const Icon =
      severity === "high" ? AlertTriangle : severity === "medium" ? Thermometer : CheckCircle2;
    ...
    return { severity, sevEmoji, Icon, barColor };
  }, [lastAlert]);
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              <div className="text-sm font-semibold">
                {content.sevEmoji} Stress Alert — {lastAlert.severity.toUpperCase()}
              </div>
