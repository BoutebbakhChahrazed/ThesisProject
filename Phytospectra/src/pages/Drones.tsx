...
export default function Drones() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader title="🚁 Drones" subtitle="Manage drones — one drone per field" gradient="gradient-gallery" />
      ...
      {availableFields.length === 0 && !creating && items.length > 0 && (
        <div className="rounded-xl border border-amber-300 bg-amber-50 text-amber-700 px-4 py-3 text-sm">
          ⚠️ All your fields already have a drone assigned. Delete a drone or add a new field first.
        </div>
      )}
