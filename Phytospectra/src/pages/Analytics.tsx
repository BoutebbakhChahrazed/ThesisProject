...
export default function Analytics() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader title="📊 Field Analytics" subtitle="Trends, comparisons and crop intelligence" gradient="gradient-analytics" />
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="bg-card rounded-2xl shadow-soft border border-border/40 p-5">
          <h3 className="font-display font-semibold mb-4">🌿 Average Health Trend (14d)</h3>
        ...
        <div className="bg-card rounded-2xl shadow-soft border border-border/40 p-5 lg:col-span-2">
          <h3 className="font-display font-semibold mb-4">📈 Stress Breakdown by Flight</h3>
